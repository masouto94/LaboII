...
void createPeople(){
    /*
     *Person alama = loadPerson("alama", 22, 'f', "arg");
    Person nanasa = loadPerson("nanasa", 26, 'f', "arg");
    Person alf = loadPerson("alf", 30, 'm', "arg");
    Person saracustica = loadPerson("saracustica", 19, 'f', "arg");
    */
    int MAX_SIZE = 2;
    int currentSize = 0;
